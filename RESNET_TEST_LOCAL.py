...
MODEL_PATH = Path(r"D:\resnet50_low_quality_results\resnet50_6class_low_quality.pth")  # Path to your trained model
TEST_DATA_ROOT = Path("./data/test")  # Root directory containing test folders
OUT_DIR = Path(r"D:\projects\redo\result-low")  # Where to save results
